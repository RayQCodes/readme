...
**Group Names:** Pragalv Bhattarai, Raymond Quan, Faizan Munir, Logan Breckenridge, Jeremiah Mccormick, Saipradhith Gudapati
...
| **ML** | Fine-tuned Gemma 2-bit (LoRA) model for human-vs-bot classification | [https://github.com/RayQCodes/ML-Model](https://github.com/RayQCodes/ML-Model) |
---
...
- **Research Paper (IEEE format):** [link to PDF or Overleaf]
- **Demo Video:** [link]
- **Poster:** [link]
